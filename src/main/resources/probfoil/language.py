...
class TypeModeLanguage(BaseLanguage):
    ...
    def __init__(self, symmetry_breaking=True, **kwargs):
        ...
        self._requireds = []    # list[tuple] : list of str predicates
    ...
    def add_requireds(self, predicate):
        """Add required predicate.

        :param predicate: predicate
        :type predicate: str
        """
        self._requireds.append(predicate)
    ...
    def load(self, data):
        ...
        for requiredinfo in data.query('required', 1):
            requiredinfo = requiredinfo[0]
            self.add_requireds(requiredinfo)

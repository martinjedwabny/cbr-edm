...
public class EDMOntDeepSimilarityFunction implements LocalSimilarityFunction {
    ...
    public double compute(Object caseObject, Object queryObject) throws NoApplicableSimilarityFunctionException {
        ...
        double ontSim = up / down;

//        System.out.println("distances(" + i1.toString()+", "+i2.toString()+") = " + ontSim + " ; " + editSim);
